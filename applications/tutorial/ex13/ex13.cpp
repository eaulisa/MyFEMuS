...
void AssembleRes(MultiLevelProblem& ml_prob) {
  ...
  solVIndex[0] = mlSol->GetIndex("VX");    // get the position of "U" in the ml_sol object
  solVIndex[1] = mlSol->GetIndex("VY");    // get the position of "V" in the ml_sol object
  if(dim == 3) solVIndex[2] = mlSol->GetIndex("VZ");       // get the position of "V" in the ml_sol object

  //solution variable
  std::vector < unsigned > solAIndex(dim);
  solAIndex[0] = mlSol->GetIndex("AX");    // get the position of "U" in the ml_sol object
  solAIndex[1] = mlSol->GetIndex("AY");    // get the position of "V" in the ml_sol object
  if(dim == 3) solAIndex[2] = mlSol->GetIndex("AZ");       // get the position of "V" in the ml_sol object
  ...
  solAPdeIndex[0] = mlPdeSys->GetSolPdeIndex("AX");    // get the position of "U" in the pdeSys object
  solAPdeIndex[1] = mlPdeSys->GetSolPdeIndex("AY");    // get the position of "V" in the pdeSys object
