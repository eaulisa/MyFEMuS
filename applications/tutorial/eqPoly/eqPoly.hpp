    ...
    double GetValue(std::vector <double> x) {
      ...
      if(_dim == 2) {
        ...
        if(_degree == 3) {
          ...
          value = _coefficients[0].real() + _coefficients[1].real() * x[0] + _coefficients[2].real() * x[1] +
                  _coefficients[3].real() * pow(x[0], 2) + _coefficients[4].real() * pow(x[1], 2) + _coefficients[5].real() * pow(x[0], 3) +
                  _coefficients[6].real() * pow(x[1], 3) + _coefficients[7].real() * pow(x[0], 2) * x[1] + 
                  _coefficients[8].real() * pow(x[1], 2) * x[0] + _coefficients[9].real() * x[0] * x[1];
        ...
        if(_degree == 4) {
          ...
          value = _coefficients[0].real() + _coefficients[1].real() * x[0] + _coefficients[2].real() * x[1] +
                  _coefficients[3].real() * pow(x[0], 2) + _coefficients[4].real() * pow(x[1], 2) + _coefficients[5].real() * pow(x[0], 3) +
                  _coefficients[6].real() * pow(x[1], 3) + _coefficients[7].real() * pow(x[0], 4) + _coefficients[8].real() * pow(x[1], 4) +
                  _coefficients[9].real() * pow(x[0], 2) * x[1] + _coefficients[10].real() * pow(x[0], 3) * x[1] +
                  _coefficients[11].real() * pow(x[1], 2) * x[0] + _coefficients[12].real() * pow(x[1], 3) * x[0] +
                  _coefficients[13].real() * x[0] * x[1] + _coefficients[14].real() * pow(x[0], 2) * pow(x[1], 2);
        ...
        if(_degree == 5) {
          ...
          value = _coefficients[0].real() + _coefficients[1].real() * x[0] + _coefficients[2].real() * x[1] +
                  ...
                  _coefficients[11].real() * pow(x[0], 2) * x[1] + _coefficients[12].real() * pow(x[0], 3) * x[1] + 
                  _coefficients[13].real() * pow(x[0], 4) * x[1] + _coefficients[14].real() * pow(x[1], 2) * x[0] + 
                  _coefficients[15].real() * pow(x[1], 3) * x[0] + _coefficients[16].real() * pow(x[1], 4) * x[0] + 
                  _coefficients[17].real() * pow(x[0], 3) * pow(x[1], 2) + _coefficients[18].real() * pow(x[1], 3) * pow(x[0], 2) + 
                  _coefficients[19].real() * x[0] * x[1] + _coefficients[20].real() * pow(x[0], 2) * pow(x[1], 2);
