...
parameter beam = parameter(false, .3, {0., 0., 0.},
                           45., 0.05, 0.05, 0.05,
                           true, false, 7850., 1000., 0.3, 2.e05, 1.0e-03,
...
//                              45., 0.05, 0.05, 0.05,
//                              false, false, 1000., 1000., 0.4, 1400000., 1.,
...
parameter turek2 = parameter(true, .3, {0., 0., 0.},
                             45., 0.05, 0.05, 0.05,
                             false, false, 10000., 1000., 0.4, 1400000., 1.,
...
parameter turek3 = parameter(true, .3, {0., 0., 0.},
                             45., 0.05, 0.05, 0.05,
                             false, false, 1000., 1000., 0.4, 4 * 1400000., 1.,
                             "../input/turekBeam2DFine.neu", 1., 5, 0,
                             "../input/turek2DNew.neu", 1., -2,
...
parameter turek0 = parameter(false, .3, {0., 0., 0.},
                             45., 0.05, 0.05, 0.05,
                             false, false, 1000., 1000., 0.4, 4 * 14000., 1.,
...
parameter channelFlip = parameter(false, .5, {0., 0., 0.},
                                  10., 0.1, 0.1, 0.1,
                                  false, true, 1500., 956., 0.45, 2.3 * 1e6, 0.145,
...
bool BoundaryConditionChannelFlip(const std::vector < double >& x, const char name[], double& value, const int facename, const double t) {
  ...
  if(!strcmp(name, "DX")) {
    ...
    if(1 == facename) {     //inlet
      if(t < 10.0) {
        value = .5 * 0.06067 * (1. - cos(M_PI * t / 10)) * 4. * x[1] * (1. - x[1]);
      }
      else {
