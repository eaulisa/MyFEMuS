...
#ifndef __femus_cut_fem_int_tri_parabola_hpp__
#define __femus_cut_fem_int_tri_parabola_hpp__
...
//   TypeA dA = static_cast<TypeA>(d);
  ...
  //      _f[count] = (*_obj)(s, {i, j}, aA, dA);
        _f[count] = find_trig_area_2intersection_formula_first(i,j,s,a,c,table, p1,p2, p3);
...
//       }
      ...
      if (table < 3){ //This is where we change the basis
        x[0] = (1. - _xgp[0][ig]);
        x[1] = _xgp[1][ig];
      }
      else{
