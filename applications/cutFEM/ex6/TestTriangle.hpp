...
void TestTriangle(const Float1 &eps) {
  ...
  std::vector<myType>a = {1., 0.000001};
  ...
  //std::cout << TriangleFull(-1, m, a, d) << " " << Triangle(-1, m, a, d) << " " << Triangle(-1, m, af, df) << std::endl;
  //std::cout << TriangleFull(0,  m, a, d) << " " << Triangle(0,  m, a, d) << " " << Triangle(0,  m, af, df) << std::endl;
  std::cout << Triangle(2,  m, a, d)<<std::endl;
  std::cout << TriangleFull(2,  m, af, df)<<std::endl;
  // << " " << Triangle(1,  m, a, d) << " " << Triangle(1,  m, af, df) << std::endl;
