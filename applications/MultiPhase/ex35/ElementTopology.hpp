...
static const unsigned HEX_FACE_VERTS[6][4] = {
  {0,1,5,4},
  {1,2,6,5},
  {2,3,7,6},
  {3,0,4,7},
...
static const unsigned HEX_EDGE_VERTS[12][2] = {
  {0,1}, {1,2}, {2,3}, {3,0},
  {4,5}, {5,6}, {6,7}, {7,4},
  {0,4}, {1,5}, {2,6}, {3,7}
};
...
// Tet15 (type id = 1)
static const unsigned TET_FACE_NODES[4][7] = {
  {0, 2, 1, 6, 5, 4,10},
  {0, 1, 3, 4, 8, 7,11},
  {1, 2, 3, 5, 9, 8,12},
  {2, 0, 3, 6, 7, 9,13}
...
static const unsigned TET_EDGE_NODES[6][3] = {
  {0,1,4}, {1,2,5}, {0,2,6},
  {0,3,7}, {1,3,8}, {2,3,9}
};

static const unsigned TET_EDGE_VERTS[6][2] = {
...
static const unsigned WDG_TRI_FACE_NODES[2][7] = {
  {0, 2, 1, 8, 7, 6,18},
  {3, 4, 5, 9,10,11,19}
};
static const unsigned WDG_TRI_FACE_VERTS[2][3] = {
  {0,2,1},
  {3,4,5}
};
...
static const unsigned Q9_EDGE_VERTS[4][2] = {
  {0,1},{1,2},{2,3},{3,0}
};
...
// Tri7 (type id = 4)
static const unsigned T7_EDGE_NODES[3][3] = {
  {0,1,3},{1,2,4},{2,0,5}
};
static const unsigned T7_EDGE_VERTS[3][2] = {
  {0,1},{1,2},{2,0}
};
...
inline const ElementTopology& topologyFromTypeId(unsigned t) {
  static const ElementTopology HEX = {3,27,8,  6, HEX_SIDES, 12, HEX_EDGES};
  static const ElementTopology TET = {3,15,4,  4, TET_SIDES,  6, TET_EDGES};
  static const ElementTopology WDG = {3,21,6,  5, WDG_SIDES,  9, WDG_EDGES};
  static const ElementTopology Q9  = {2, 9,4,  4, Q9_SIDES,   4, Q9_EDGES};
  static const ElementTopology T7  = {2, 7,3,  3, T7_SIDES,   3, T7_EDGES};
  static const ElementTopology L3  = {1, 3,2,  2, L3_SIDES,   1, L3_EDGES};
  ...
  switch (t) {
    ...
    case 5: return L3;
    default:
      throw std::runtime_error("topologyFromTypeId: unknown element type id (expected 0..5)");
  }
}
