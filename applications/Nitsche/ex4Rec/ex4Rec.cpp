...
// system.AddSolutionToSystemPDE("P2");
  ...
  std::cout << xp.size() << " " << xp[xp.size() - 1][0] << xp[xp.size() - 1][1] << std::endl;
  ...
  std::cout << lineIPoints[0].size() << " " << lineIPoints[0][lineIPoints[0].size() - 1][0] << lineIPoints[0][lineIPoints[0].size() - 1][1] << std::endl;
