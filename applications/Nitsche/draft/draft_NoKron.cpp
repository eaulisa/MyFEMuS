...
int main(int argc, char** args) {
  ...
  std::vector<std::vector<std::vector<double>>> GR(7);
    GR = { Gauss1, Gauss2, Gauss3, Gauss4, Gauss5, Gauss6, Gauss7,Gauss8, Gauss9, Gauss10, Gauss11, Gauss12, Gauss13, Gauss14,Gauss15};

  std::vector<double> N1 = {40, 80, 120, 150};


  std::ofstream fout;
  fout.open("PerformanceNoKron.txt", std::ofstream::app);
