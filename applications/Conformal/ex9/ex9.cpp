...
#include "../include/assembleConformalMinimization11AD.hpp"
...
double InitalValueMu(const std::vector < double >& x) {
  return 0.;
}
...
const Parameter squareQuad = Parameter("square with quads", 0, false, false, 4, 1, true, 500, 1, 0.811569);
...
//  return 1;
  ...
  mlSol.Initialize("mu1", InitalValueMu);
  mlSol.Initialize("mu2", InitalValueMu);
