...
#include "./include/updateMu10.hpp"
...
//const Parameter cylinderConstrained = Parameter("cylinder constrained", 3, true, true, 4, 2, true, 100, 1, 0.793786); //normal constraint
const Parameter cylinderConstrained = Parameter("cylinder constrained", 3, true, true, 5, 1, true, 2, 20, 0.746343);
...
//  return 1;
  ...
  if(parameter.constraintIsOn) {
    mlSol.AddSolution("L1", LAGRANGE, feOrder, 0);
    mlSol.AddSolution("L2", LAGRANGE, feOrder, 0);
    mlSol.AddSolution("L3", LAGRANGE, feOrder, 0);
  }
...
//   mlSol.FixSolutionAtOnePoint("mu2");
  ...
  if(parameter.constraintIsOn) {
    system.AddSolutionToSystemPDE("L1");
    system.AddSolutionToSystemPDE("L2");
    system.AddSolutionToSystemPDE("L3");
  }
  if(areaConstraint) {
