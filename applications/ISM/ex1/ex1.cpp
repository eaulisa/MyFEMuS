...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a2QUAD(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a3QUAD(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a4QUAD(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a5QUAD(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a6QUAD(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a7QUAD(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a8QUAD(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//         std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//         Marker a9QUAD( x, VOLUME, mlMsh.GetLevel(0), solType );
//         //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//         std::cout<< " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," <<x[2]<<std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a1TRI(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a2TRI(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a3TRI(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a4TRI(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a1HEX(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a2HEX(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a3HEX(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a4HEX(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a5HEX(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a6HEX(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a7HEX(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a1TET(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a2TET(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a1WEDGE(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
...
// 
//       std::cout << " --------------------------------------------------------------------------------------------- " << std::endl;
//       Marker a2WEDGE(x, VOLUME, mlMsh.GetLevel(0), solType);
//       //Marker a( x, VOLUME, mlMsh.GetLevel(numberOfUniformLevels + numberOfSelectiveLevels -1) );
//       std::cout << " The coordinates of the marker are " << x[0] << " ," << x[1] << " ," << x[2] << std::endl;
