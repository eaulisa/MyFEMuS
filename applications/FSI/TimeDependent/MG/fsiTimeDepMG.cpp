...
int main(int argc, char **args) {
  ...
  if(argc >= 2) {
    ...
    else if(!strcmp("flipped_beam_FSI", args[1])) { /** Comsol 2D vertical beam benchmark */
      simulation = 8;
      dimension2D = 1;
    }
  ...
  else if(8 == simulation) {
    infile = "./input/ChannelFlipFitted.neu";
  }
  ...
  if(1 == simulation || 2 == simulation)
    ...
    ml_sol.AttachSetBoundaryConditionFunction(BoundaryConditionChannelFlip);
  ...
  if(turek_FSI == 2 || turek_FSI == 3 || simulation == 8)
  ...
  //system.SetResidualUpdateConvergenceTolerance(1.e-10);
