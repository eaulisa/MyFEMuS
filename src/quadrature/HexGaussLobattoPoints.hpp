...
#ifndef __femus_quadrature_HexGaussLobattoPoints_hpp__
#define __femus_quadrature_HexGaussLobattoPoints_hpp__

namespace femus {

 class hex_gaussLobatto {
 public:
 ...
 static const double Gauss3[4][27];
 static const double Gauss4[4][64];
 static const double Gauss5[4][64];
 static const double Gauss6[4][125];
 static const double Gauss7[4][125];
