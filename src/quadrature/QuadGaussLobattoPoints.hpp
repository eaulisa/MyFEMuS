...
#ifndef __femus_quadrature_QuadGaussLobattoPoints_hpp__
#define __femus_quadrature_QuadGaussLobattoPoints_hpp__

namespace femus {

 class quad_gaussLobatto {
 public:
 ...
 static const double Gauss3[3][9];
 static const double Gauss4[3][16];
 static const double Gauss5[3][16];
 static const double Gauss6[3][25];
 static const double Gauss7[3][25];
 static const double Gauss8[3][36];
 static const double Gauss9[3][36];
 static const double Gauss10[3][49];
 static const double Gauss11[3][49];
 static const double Gauss12[3][64];
 static const double Gauss13[3][64];
